namespace TESVSnip.UI.Forms
{
  ...
  internal partial class MainView : Form
  {
    ...
    static string mruRegKey = "SOFTWARE\\TESVSnip (Skyrim Edition)\\MRU";
    ...
    public MainView()
    {
      ...
      mruMenu = new MruStripMenu(recentFilelToolStripMenuItem, new MruStripMenu.ClickedHandler(OnMruFile), mruRegKey + "\\MRU", true, 16);
    }
